...
本仓库为「Gemini 中文指南」的中文资料镜像，收录 Gemini中文站 官网相关文章 15 篇（教程与指南 7 篇、版本动态 8 篇），统一整理为 Markdown。每篇文章都保留官网原文链接，可在线阅读，也可 `git clone` 到本地，用于检索、离线阅读或交给 AI 工具做学习总结；内容持续跟随官网更新。
